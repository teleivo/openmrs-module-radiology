...
var renderDatatables = (function() {

  var dataTable = $j('table#radiologyOrdersTable').DataTable(
          {
            "order": [[1, 'asc']],
            "oLanguage": {
  ...
  $j('#radiologyOrdersTableBody').on(
          ...
          function() {
            ...
            if (row.child.isShown()) {
              ...
              row.child(
                      format(tr.data('child-order_id'), tr
                              .data('child-physician'),
                              tr.data('child-status'), tr
