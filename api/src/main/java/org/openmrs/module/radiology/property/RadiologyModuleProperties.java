...
@Component
class RadiologyModuleProperties extends ModuleProperties {
	...
	public String getMppsDir() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_MPPS_DIR, true);
	}
	...
	public String getMwlDir() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_MWL_DIR, true);
	}
	...
	public String getPacsAddress() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_PACS_ADDRESS, true);
	}
	...
	public String getPacsHL7Port() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_PACS_HL7_PORT, true);
	}
	...
	public String getPacsDicomAeTitle() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_PACS_DICOM_AE_TITLE, true);
	}
	...
	public String getDicomMppsPort() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_MPPS_PORT, true);
	}
	...
	public String getDicomAeTitle() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_AE_TITLE, true);
	}
	...
	public String getDicomUIDOrgRoot() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_UID_ORG_ROOT, true);
	}
	...
	public String getDicomUIDApplication() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_UID_APPLICATION, true);
	}
	...
	public String getDicomUIDTypeStudy() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_UID_TYPE_STUDY, true);
	}
	...
	public String getDicomSpecificCharacterSet() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_SPECIFIC_CHARCATER_SET, true);
	}
	...
	public String getDicomWebViewerAddress() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_WEB_VIEWER_ADDRESS, true);
	}
	...
	public String getDicomWebViewerPort() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_WEB_VIEWER_PORT, true);
	}
	...
	public String getDicomWebViewerBaseUrl() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_WEB_VIEWER_BASE_URL, true);
	}
	...
	public String getDicomWebViewerLocalServerName() {
		return getGlobalProperty(RadiologyModulePropertyConstants.GP_DICOM_WEB_VIEWER_LOCAL_SERVER_NAME, false);
	}
	...
	public CareSetting getRadiologyCareSetting() {
		final String radiologyCareSettingUuid = getGlobalProperty(
			RadiologyModulePropertyConstants.GP_RADIOLOGY_CARE_SETTING, true);
	...
	public OrderType getRadiologyTestOrderType() {
		return getOrderTypeByGlobalProperty(RadiologyModulePropertyConstants.GP_RADIOLOGY_TEST_ORDER_TYPE);
	}
	...
	public EncounterType getRadiologyOrderEncounterType() {
		return getEncounterTypeByGlobalProperty(RadiologyModulePropertyConstants.GP_RADIOLOGY_ORDER_ENCOUNTER_TYPE);
	}
	...
	public EncounterRole getRadiologyOrderingProviderEncounterRole() {
		return getEncounterRoleByGlobalProperty(RadiologyModulePropertyConstants.GP_RADIOLOGY_ORDERING_PROVIDER_ENCOUNTER_ROLE);
	}
	...
	public VisitType getRadiologyVisitType() {
		return getVisitTypeByGlobalProperty(RadiologyModulePropertyConstants.GP_RADIOLOGY_VISIT_TYPE);
	}
	...
	public String getRadiologyConceptClassNames() {
		...
		String radiologyConceptClassUuidSetting = getGlobalProperty(
			RadiologyModulePropertyConstants.GP_RADIOLOGY_CONCEPT_CLASSES, true);
